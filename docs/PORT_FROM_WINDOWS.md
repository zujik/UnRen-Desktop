...
Reference Windows spec (archived): `../${UNREN_LOCAL}/_archive/unren-legacy/UnRen-forall-la_0.77-le_9.7.60-cu_9.7.80/`
...
| dikau-UnRen-sh | Ancestor only; archived at `../${UNREN_LOCAL}/_archive/unren-legacy/dikau-UnRen-sh/` |
...
Use **`rpycCorrector_1.04`** from `../${UNREN_LOCAL}/_archive/unren-legacy/misc/` — forall `.bat` does not embed it.
