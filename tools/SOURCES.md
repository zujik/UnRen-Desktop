...
|------|------|--------|-------|
| rpycCorrector | `tools/rpyccorrect-py3/` | AON/SC4X v1.04 ([F95 thread](https://f95zone.to/threads/rpyccorrector-1-04-rpyc-signature-corrector-formerly-sigcorrector.26320/)) | py3 port; menu **c** / option **9** |
...
| rpatool | `tools/rpatool-py3/` | [shiz/rpatool](https://codeberg.org/shiz/rpatool) | Standard `.rpa` |
| unrpyc | `tools/unrpyc-py3/` | [CensoredUsername/unrpyc](https://github.com/CensoredUsername/unrpyc) v2.0.4 + patches | `--try-harder` / deobfuscate |
...
**Windows feature reference:** [UnRen-forall](https://github.com/Lurmel/UnRen-forall) release `la_0.77-le_9.7.60-cu_9.7.80` — see `docs/PORT_FROM_WINDOWS.md`.
