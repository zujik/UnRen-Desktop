...
|------|------|--------|-------|
| rpycCorrector | `tools/rpyccorrect-py3/` | AON/SC4X v1.04 (`../UnRen-Local/_archive/.../rpycCorrector_1.04`) | py3 port; menu **c** / option **9** |
...
**Windows feature reference** (pre-port spec): `../UnRen-Local/_archive/unren-legacy/UnRen-forall-la_0.77-le_9.7.60-cu_9.7.80/`
